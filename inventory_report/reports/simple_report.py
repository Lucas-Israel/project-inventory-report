...
class SimpleReport:
    @staticmethod
    def generate(list):
        oldest_product = SimpleReport.__get_oldest_product(list)
        nearest_expiration = SimpleReport.__get_nearest_expiration_date(list)
        most_products = SimpleReport.__get_company_with_more_products(list)
        return SimpleReport.__generate_message(
            oldest_product, nearest_expiration, most_products
        )

    @staticmethod
    def __get_oldest_product(list):
        oldest = ""
    ...
    @staticmethod
    def __get_nearest_expiration_date(list):
        newest = ""
        today = datetime.today().strftime("%Y%m%d")
    ...
    @staticmethod
    def __get_company_with_more_products(list):
        new_list = []
    ...
    @staticmethod
    def __generate_message(old_prod, nearest_expiration, most_prod):
        return (
